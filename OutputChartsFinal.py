...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        instuctions_label = ttk.Label(self,
                                      text="Please enter the Period, the Worst Case Execution time, and the Actual Execution time for each Task.",
                                      font=SMALLFONT)
        instuctions_P_label = ttk.Label(self,
                                        text="You can use preselected P-State values and/or enter your own.",
                                        font=SMALLFONT)
        instuctions_num_label = ttk.Label(self,
                                          text="This simulator accepts a maximum of 5 Tasks and 8 P-states.",
                                          font=SMALLFONT)
...
class Page1(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def remove_p():
            ...
            if count_P > MIN_NUM_P:
                ...
                tk.messagebox.showwarning(title="Error",
                                          message="Please select at least one custom P-State or use the preselected options above")
        ...
        ADD_P = ttk.Button(frame_add_remove_p, text='(+) ADD P-STATE', command=add_p).grid(row=8, column=1, padx=10,
                                                                                           pady=10, sticky='s')
        # Create Remove task button and place
        REMOVE_P = ttk.Button(frame_add_remove_p, text='(-) REMOVE P-STATE', command=remove_p).grid(row=8, column=2,
                                                                                                    padx=10, pady=10,
                                                                                                    sticky='s')
        ...
        # Create Task Button and place
        ADD_P = ttk.Button(frame_add_remove_T, text='(+) ADD TASK', command=add).grid(row=14, column=1, padx=10,
                                                                                      pady=10, sticky='w')

        # Create Remove task button and place
        REMOVE_P = ttk.Button(frame_add_remove_T, text='(-) REMOVE TASK', command=remove).grid(row=14, column=2,
                                                                                               padx=10, pady=10,
                                                                                               sticky='e')
