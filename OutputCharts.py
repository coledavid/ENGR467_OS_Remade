...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        instuctions_label = ttk.Label(self,
                                      text="please enter the period, the worst case execution time and the actual execution time in the following page",
                                      font=SMALLFONT)
...
class Page1(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        ADD_P = ttk.Button(frame_add_remove_p, text='(+) ADD P-STATE', command=add_p).grid(row=14, column=1, padx=10,
                                                                                           pady=10, sticky='s')
        # Create Remove task button and place
        REMOVE_P = ttk.Button(frame_add_remove_p, text='(-) REMOVE P-STATE', command=remove_p).grid(row=14, column=2,
                                                                                                    padx=10, pady=10,
                                                                                                    sticky='s')
        ...
        # Create Task Button and place
        ADD_P = ttk.Button(frame_add_remove_T, text='(+) ADD TASK', command=add).grid(row=16, column=1, padx=10,
                                                                                      pady=10, sticky='w')

        # Create Remove task button and place
        REMOVE_P = ttk.Button(frame_add_remove_T, text='(-) REMOVE TASK', command=remove).grid(row=16, column=2,
                                                                                               padx=10, pady=10,
                                                                                               sticky='e')
